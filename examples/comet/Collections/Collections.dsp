...
!MESSAGE 
!MESSAGE "Collections - Win32 Release" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "Collections - Win32 Debug" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
OutDir=.\Release
TargetPath=.\Release\Collections.dll
InputPath=.\Release\Collections.dll
SOURCE="$(InputPath)"
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /Yu"std.h" /FD /GZ /c
...
# Begin Custom Build - Performing registration
OutDir=.\Debug
TargetPath=.\Debug\Collections.dll
InputPath=.\Debug\Collections.dll
SOURCE="$(InputPath)"
...
SOURCE=.\Collections.def
# End Source File
# Begin Source File

SOURCE=.\Collections.idl

!IF  "$(CFG)" == "Collections - Win32 Release"

# PROP Ignore_Default_Tool 1
# Begin Custom Build - Compiling Type Library.
InputPath=.\Collections.idl
InputName=Collections

BuildCmds= \
	idl2h $(InputName)

"Collectionslib.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"Collections.tlb" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
...
"CometExampleCollections.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
