...
struct DECLSPEC_UUID("D1855C2E-2275-4B80-9657-E1E6E26AFB64") ICache : public ::IDispatch {
    ...
    virtual STDMETHODIMP raw_Remove(BSTR par___MIDL__ICache0000) = 0;
};
...
template<> struct wrap_t<LSCache::ICache> {
    ...
    inline void Remove(const bstr_t& par___MIDL__ICache0000);
...
inline void wrap_t<LSCache::ICache>::Remove(const bstr_t& par___MIDL__ICache0000)
{
    HRESULT _hr_ = reinterpret_cast<LSCache::ICache*>(this)->raw_Remove(par___MIDL__ICache0000.in());
    if (FAILED(_hr_)) throw_com_error(reinterpret_cast<LSCache::ICache*>(this), _hr_);
}
...
struct ATL_NO_VTABLE DECLSPEC_UUID("D1855C2E-2275-4B80-9657-E1E6E26AFB64") ICacheImpl : public impl_dispatch<_S, _TL>
{
    ...
    STDMETHODIMP raw_Remove(BSTR par___MIDL__ICache0000);
...
/*
    ...
    long GetMaxSize();
    void Remove(const bstr_t& par___MIDL__ICache0000);
*/
};
...
template<typename _B, typename _S, typename _TL>
STDMETHODIMP ICacheImpl<_B, _S, _TL>::raw_Remove(BSTR par___MIDL__ICache0000)
{
    try {
        /*
          void Remove(const bstr_t& par___MIDL__ICache0000);
        */
        static_cast<_B*>(this)->Remove(bstr_t::create_const_reference(par___MIDL__ICache0000));
